...
public interface SerieRepository extends JpaRepository<Serie, Long> {
    ...
    @Query("select e from Serie s JOIN s.episodios e WHERE s.id = :idSerie AND e.temporada = :temporada")
    List<Episodio> episodiosPorTemporada(Long idSerie, Integer temporada);
}
